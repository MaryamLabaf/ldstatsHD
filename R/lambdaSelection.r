...
lambdaSelection <- function(obj, criterion=c("PC", "AGNES", "A-MSE", "VUL", "STARS", "AIC", "BIC"), ...)
{
  ...
  pcriterion <- c("PC","AGNES","A-MSE","STARS","VUL", "BIC", "AIC")
  ...
  if(criterion[1] == "AIC"|criterion[1] == "BIC")
